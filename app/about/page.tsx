    ...
    <div className="bg-[#FBFBF9] min-h-screen py-10">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center mb-24">
          ...
          <div className="lg:col-span-5 relative h-[380px] sm:h-[450px] w-full overflow-hidden rounded-none border border-[#2A1E17]/5 shadow-md">
            <Image
        ...
        <section className="bg-[#EFEFEA]/45 rounded-none p-8 sm:p-12 lg:p-16 mb-24 border border-[#2A1E17]/5">
          <div className="text-center max-w-2xl mx-auto mb-12 sm:mb-16 space-y-3">
            ...
            <div className="h-0.5 w-12 bg-[#C5A880] mx-auto rounded-none" />
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-[#FBFBF9] p-6 rounded-none border border-[#2A1E17]/5 space-y-4">
              <div className="w-12 h-12 border border-[#2A1E17]/10 bg-white flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.8} stroke="currentColor" className="w-6 h-6 text-[#C5A880]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center mb-24">
          {/* Left: Chef Image */}
          <div className="lg:col-span-5 order-last lg:order-first relative h-[380px] sm:h-[450px] w-full overflow-hidden rounded-none border border-[#2A1E17]/5 shadow-md bg-[#2A1E17]/5">
            <Image
          ...
          <div className="lg:col-span-7 space-y-6 text-[#3A2E2B]/90">
            ...
            <div className="h-0.5 w-12 bg-[#C5A880] rounded-none" />
            <p className="font-sans text-sm sm:text-base leading-relaxed">
        ...
        <section className="bg-[#2A1E17] text-white rounded-none p-8 sm:p-12 lg:p-16 text-center space-y-6 relative overflow-hidden shadow-lg">
          ...
          <div className="pt-4 relative z-10">
            <Link
              href="/menu"
              className="inline-block rounded-none bg-[#C5A880] text-[#2A1E17] px-8 py-3.5 text-xs font-bold uppercase tracking-wider transition-all duration-300 hover:bg-[#FBFBF9] hover:text-[#2A1E17] shadow-sm hover:shadow-md cursor-pointer"
            >
              Explore Our Menu
            </Link>
          </div>
