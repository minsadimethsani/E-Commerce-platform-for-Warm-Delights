          ...
          <aside className="hidden lg:block w-64 flex-shrink-0 space-y-8">
            <div className="bg-[#EFEFEA]/50 border border-[#2A1E17]/5 rounded-none p-6 space-y-6">
              ...
              <div className="space-y-2">
                <div className="h-3 w-10 bg-gray-200/60 rounded-none animate-pulse" />
                <div className="h-9 w-full bg-gray-200/60 rounded-none animate-pulse" />
              </div>

              {/* Categories list skeleton */}
              <div className="space-y-2">
                <div className="h-3 w-16 bg-gray-200/60 rounded-none animate-pulse" />
                <div className="space-y-3 pt-1">
                  <div className="h-3.5 w-24 bg-gray-200/60 rounded-none animate-pulse" />
                  <div className="h-3.5 w-16 bg-gray-200/60 rounded-none animate-pulse" />
                  <div className="h-3.5 w-20 bg-gray-200/60 rounded-none animate-pulse" />
                  <div className="h-3.5 w-14 bg-gray-200/60 rounded-none animate-pulse" />
                </div>
              </div>

              {/* Price range skeleton */}
              <div className="space-y-2">
                <div className="h-3 w-20 bg-gray-200/60 rounded-none animate-pulse" />
                <div className="flex items-center space-x-2">
                  <div className="h-8 w-1/2 bg-gray-200/60 rounded-none animate-pulse" />
