        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 xl:gap-16 items-start mb-24">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="h-10 w-3/4 bg-gray-200/50 rounded animate-pulse" />
              
              {/* Rating skeleton */}
              <div className="flex items-center space-x-2 pt-1">
                <div className="h-4 w-24 bg-gray-200/50 rounded animate-pulse" />
                <div className="h-4 w-12 bg-gray-200/50 rounded animate-pulse" />
              </div>

              {/* Price skeleton */}
              <div className="h-8 w-28 bg-gray-200/50 rounded animate-pulse" />
            </div>

            {/* Description skeleton */}
            <div className="space-y-2">
              <div className="h-3.5 w-full bg-gray-200/50 rounded animate-pulse" />
              <div className="h-3.5 w-full bg-gray-200/50 rounded animate-pulse" />
              <div className="h-3.5 w-4/5 bg-gray-200/50 rounded animate-pulse" />
            </div>
        ...
        <section className="border-t border-[#2d1e18]/10 pt-16 mb-16">
          <div className="flex justify-between items-end mb-10">
            <div className="space-y-2">
              ...
              <div className="h-6 w-48 bg-gray-200/50 rounded animate-pulse" />
            </div>
