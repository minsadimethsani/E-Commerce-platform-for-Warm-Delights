      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <nav aria-label="Breadcrumb" className="mb-12">
          <ol className="flex items-center space-x-2 text-xs font-semibold uppercase tracking-wider text-[#2A1E17]/60">
            <li>
              <Link href="/" className="hover:text-[#DD9E59] transition-colors cursor-pointer">
                Home
              </Link>
            </li>
            ...
            <li>
              <Link href="/menu" className="hover:text-[#DD9E59] transition-colors cursor-pointer">
                Menu
              </Link>
            </li>
            <li className="flex items-center space-x-2">
        ...
        <div className="flex flex-col items-center text-center max-w-2xl mx-auto py-8 mb-16 animate-fade-in">
          ...
          <div className="relative mb-6">
            <div className="absolute inset-0 bg-[#DD9E59]/5 rounded-full blur-xl animate-pulse"></div>
            <svg
            ...
            >
              ...
              {/* Glass Dome */}
              <path d="M26 68 C26 30 74 30 74 68 Z" stroke="#2A1E17" strokeWidth="4" strokeLinejoin="round" fill="#F0D8A1" fillOpacity="0.3" />
              <circle cx="50" cy="27" r="4.5" fill="#F0D8A1" stroke="#2A1E17" strokeWidth="3" />

              {/* Glass glare line */}
              <path d="M33 50 A 20 20 0 0 1 48 35" stroke="#DD9E59" strokeWidth="2.5" strokeLinecap="round" opacity="0.6" />

              {/* Crumb Silhouette (Empty stand) */}
              <circle cx="45" cy="67" r="1.5" fill="#DD9E59" />
              <circle cx="56" cy="68" r="1" fill="#DD9E59" />
              <circle cx="38" cy="68" r="1.2" fill="#DD9E59" opacity="0.7" />
            </svg>
          </div>

          <span className="text-xs font-bold uppercase tracking-widest text-[#DD9E59] mb-3">
            Treat Unavailable
          </span>
          <h1 className="font-serif text-3xl sm:text-4xl font-bold tracking-tight text-[#2A1E17] mb-4">
            Where Did the Treat Go?
          </h1>
          <p className="font-sans text-sm text-[#2A1E17]/80 leading-relaxed mb-8 max-w-md">
          ...
          <Link
            href="/menu"
            className="rounded-none bg-[#A47251] text-white px-8 py-3 text-xs font-bold uppercase tracking-wider transition-all duration-300 hover:bg-[#DD9E59] hover:text-[#2A1E17] shadow-sm hover:shadow-md cursor-pointer"
          >
            Explore All Treats
          </Link>
        </div>
        ...
        <section className="border-t border-[#A47251]/10 pt-16 mb-12">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-10">
            ...
            <Link
              href="/menu"
              className="mt-4 sm:mt-0 text-xs font-bold uppercase tracking-wider text-[#2A1E17] hover:text-[#DD9E59] flex items-center transition-colors cursor-pointer group"
            >
