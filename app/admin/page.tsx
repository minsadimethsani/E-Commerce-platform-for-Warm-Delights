  ...
  return (
    <div className="space-y-10">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
        {/* Sales Card */}
        <div className="rounded-2xl border border-[#A47251]/5 bg-[#F0D8A1]/50 p-6 transition-all hover:bg-[#F0D8A1] hover:-translate-y-0.5 hover:shadow-xs">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold uppercase tracking-wider text-[#2A1E17]/60">Total Revenue</span>
            <div className="border border-[#A47251]/10 p-1 bg-white">
          ...
          <div className="mt-4">
            ...
            <span className="block mt-1 text-[10px] font-semibold text-[#2A1E17]">Excludes cancelled orders</span>
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-[#A47251]/5 bg-[#F0D8A1]/50 p-6 transition-all hover:bg-[#F0D8A1] hover:-translate-y-0.5 hover:shadow-xs">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold uppercase tracking-wider text-[#2A1E17]/60">Active Orders</span>
            <div className="border border-[#A47251]/10 p-1 bg-white">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.8} stroke="currentColor" className="w-4 h-4 text-[#2A1E17]">
          ...
          <div className="mt-4">
            ...
            <span className="block mt-1 text-[10px] font-semibold text-[#DD9E59]">Requires baking / dispatch</span>
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-[#A47251]/5 bg-[#F0D8A1]/50 p-6 transition-all hover:bg-[#F0D8A1] hover:-translate-y-0.5 hover:shadow-xs">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold uppercase tracking-wider text-[#2A1E17]/60">Total Products</span>
            <div className="border border-[#A47251]/10 p-1 bg-white">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.8} stroke="currentColor" className="w-4 h-4 text-[#2A1E17]">
          ...
          <div className="mt-4">
            ...
            <span className="block mt-1 text-[10px] font-semibold text-[#2A1E17]/60">Items in online catalog</span>
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-[#A47251]/5 bg-[#F0D8A1]/50 p-6 transition-all hover:bg-[#F0D8A1] hover:-translate-y-0.5 hover:shadow-xs">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold uppercase tracking-wider text-[#2A1E17]/60">Average Rating</span>
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="flex items-center justify-between">
            ...
            <Link
              href="/admin/orders"
              className="text-xs font-bold uppercase tracking-wider text-[#DD9E59] hover:text-[#2A1E17] transition-colors"
            >
              Manage Orders &rarr;
            </Link>
          </div>
          ...
          <div className="overflow-hidden rounded-2xl border border-[#A47251]/5 bg-white shadow-xs">
            {recentOrders.length === 0 ? (
              <div className="p-12 text-center text-[#2A1E17]/60 text-sm">
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-[#A47251]/5">
                  <thead className="bg-[#F0D8A1]">
                    <tr>
                      <th className="px-6 py-4 text-left text-xs font-bold uppercase tracking-wider text-[#2A1E17]/60">Order ID</th>
                      <th className="px-6 py-4 text-left text-xs font-bold uppercase tracking-wider text-[#2A1E17]/60">Items Count</th>
                  ...
                  <tbody className="divide-y divide-[#A47251]/5 bg-white">
                    {recentOrders.map((order) => (
                      <tr key={order.id} className="hover:bg-[#F0D8A1]/30 transition-colors">
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-2xl border border-[#A47251]/5 bg-white p-6 shadow-xs space-y-4">
            {topProducts.map((p) => (
              <div key={p.id} className="flex items-center justify-between pb-3 border-b border-[#A47251]/5 last:border-0 last:pb-0">
                <div className="flex items-center space-x-3">
                  <div className="relative h-10 w-10 flex-shrink-0 overflow-hidden rounded-lg bg-[#A47251]/5">
                    <img
                      src={p.image}
                      alt={p.name}
                  ...
                  <div>
                    ...
                    <span className="text-[10px] text-[#2A1E17]/60 uppercase font-semibold">{p.category}</span>
                  </div>
                </div>
