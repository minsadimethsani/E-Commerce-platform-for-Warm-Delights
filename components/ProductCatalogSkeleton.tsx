      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 lg:mb-16">
          <div className="space-y-4 max-w-xl">
            ...
            {/* Main title shimmer */}
            <div className="h-10 w-3/4 sm:w-2/3 bg-gray-200/60 rounded-none animate-pulse" />
          </div>
          ...
          <div className="mt-4 md:mt-0 space-y-2 max-w-md w-full">
            ...
            <div className="h-3.5 w-5/6 bg-gray-200/60 rounded-none animate-pulse" />
          </div>
        </div>
        ...
        <div className="flex flex-col space-y-6 lg:space-y-0 lg:flex-row lg:items-center lg:justify-between border-b border-[#A47251]/10 pb-8 mb-10">
          ...
          <div className="flex flex-wrap gap-2 pb-2 lg:pb-0">
            {Array.from({ length: 6 }).map((_, i) => (
              <div key={i} className="h-8 w-24 bg-gray-200/60 rounded-none animate-pulse" />
            ))}
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-stretch sm:items-center w-full lg:w-auto">
            ...
            <div className="h-9 w-full sm:w-64 bg-gray-200/60 rounded-none animate-pulse" />
            {/* Sort Selector skeleton */}
            <div className="h-9 w-full sm:w-40 bg-gray-200/60 rounded-none animate-pulse" />
          </div>
        </div>

        {/* Dynamic Count shimmer */}
        <div className="mb-6 h-4 w-28 bg-gray-200/60 rounded-none animate-pulse" />
