export default function ProductCardSkeleton() {
  return (
    <div className="flex flex-col overflow-hidden rounded-none bg-[#F0D8A1]/30 border border-[#A47251]/5">
      {/* Image Block shimmer */}
      ...
      <div className="flex flex-1 flex-col justify-between p-6 space-y-4">
        ...
        <div className="pt-4 border-t border-[#A47251]/5 flex items-center justify-between">
          {/* Price label shimmer */}
