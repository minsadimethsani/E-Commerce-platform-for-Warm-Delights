      ...
      <div className="flex flex-1 flex-col justify-between p-6 space-y-4">
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <div className="h-3 w-12 bg-gray-200/50 animate-pulse rounded" />
            {/* Rating stars block shimmer */}
            <div className="h-3 w-16 bg-gray-200/50 animate-pulse rounded" />
          </div>
          {/* Title shimmer */}
          <div className="h-5 w-2/3 bg-gray-200/50 animate-pulse rounded" />
          {/* Description line shimmers */}
          <div className="space-y-1">
            <div className="h-3 w-full bg-gray-200/50 animate-pulse rounded" />
            <div className="h-3 w-4/5 bg-gray-200/50 animate-pulse rounded" />
          </div>
        </div>
        ...
        <div className="pt-4 border-t border-[#2A1E17]/5 flex items-center justify-between">
          ...
          <div className="h-8 w-8 bg-gray-200/50 animate-pulse rounded-full" />
        </div>
      </div>
    </div>
  );
