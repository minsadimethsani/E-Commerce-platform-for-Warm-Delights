...
export default function Story() {
  return (
    ...
    <section className="bg-[#EFEFEA] pt-2 pb-12 sm:pt-4 sm:pb-20 border-y border-[#2A1E17]/5">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          <div className="space-y-8 pt-2">
            ...
            <p className="text-base leading-relaxed text-[#3A2E2B]/85 font-sans">
            ...
            {/* Quick Stats Grid */}
            <div className="grid grid-cols-2 gap-6 pt-6 border-t border-[#2A1E17]/8">
              <div>
                <p className="font-serif text-3xl font-bold text-[#2A1E17]">100%</p>
                <p className="mt-1 text-xs font-semibold uppercase tracking-wider text-[#3A2E2B]/60">
                  Natural Ingredients
                </p>
              </div>
              <div>
